...
// ==============================================================
`timescale 1ns/1ps
module svm_accel_control_s_axi
#(parameter
...
// 0x24 : reserved
// 0x28 : Data signal of n_sv
//        bit 31~0 - n_sv[31:0] (Read/Write)
// 0x2c : reserved
...
localparam
    ...
    ADDR_N_SV_DATA_0         = 6'h28,
    ADDR_N_SV_CTRL           = 6'h2c,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_N_SV_DATA_0)
            int_n_sv[31:0] <= (WDATA[31:0] & wmask) | (int_n_sv[31:0] & ~wmask);
    end
end
