...
// ==============================================================
`timescale 1ns/1ps
module knn_accel_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_NUM_TRAIN_DATA_0    = 6'h28,
    ADDR_NUM_TRAIN_CTRL      = 6'h2c,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_NUM_TRAIN_DATA_0: begin
                    rdata <= int_num_train[31:0];
                end
...
assign num_train         = int_num_train;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_num_train[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_NUM_TRAIN_DATA_0)
            int_num_train[31:0] <= (WDATA[31:0] & wmask) | (int_num_train[31:0] & ~wmask);
    end
end
