// mlp_engine.h -- MLP on SCALED [0,1] data, float32 weights
#pragma once
#include <Arduino.h>
#include <pgmspace.h>
#include <math.h>
...
// raw = raw cm values; internally scaled to [0,1]
...
void mlp_eval() {
    eval_testset_scaled("MLP 8-8-3", mlp_predict, ML_CLASS_NAMES);
}