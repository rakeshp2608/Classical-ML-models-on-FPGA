// esp32_cancer.ino -- All 5 models: DT | RF | KNN | SVM | MLP (Breast Cancer)
#include <Arduino.h>
#include "utils.h"
#include "dt_engine.h"
#include "rf_engine.h"
...
static const ModelDesc MODELS[] = {
    ...
    {"MLP 16-16-2",   mlp_predict, mlp_eval},
};
...
void setup() {
    ...
    Serial.println("================================================");
    Serial.println("  ESP32 Breast Cancer ML: DT|RF|KNN|SVM|MLP");
