// utils.h -- Wine dataset: 13 features, 3 classes
#pragma once
#include <Arduino.h>
#include <pgmspace.h>
...
// ── Scale raw → int16 quantized (DT/RF: x_q=raw*QSCALE) ─────
...
// ── Scale raw → int16 quantized (SVM/MLP: MinMaxScaler) ──────
...
// ── Eval: SVM / MLP — uses ML_X_TEST_SC ─────────────────────
